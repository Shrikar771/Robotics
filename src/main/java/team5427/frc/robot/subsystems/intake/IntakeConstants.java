...
public final class IntakeConstants {
    ...
    static{
        ...
        kPivotMotorConfiguration.isInverted = false; //If motor and mechanism move the same way, then it is not inverted
        kPivotMotorConfiguration.mode = MotorMode.kServo;
        kPivotMotorConfiguration.withFOC = true;
        

        kPivotMotorConfiguration.maxVelocity = kPivotMotorConfiguration.getStandardMaxVelocity(MotorUtil.kKrakenX60FOC_MaxRPM);
        kPivotMotorConfiguration.maxAcceleration = kPivotMotorConfiguration.getStandardMaxVelocity(MotorUtil.kKrakenX60FOC_MaxRPM)*2.0;
        
        kPivotMotorConfiguration.altV = kPivotMotorConfiguration.getStandardMaxVelocity(MotorUtil.kKrakenX60FOC_MaxRPM)/2.0;
    ...
    static{
        ...
        kRollerMotorConfiguration.isInverted = false; //If motor and mechanism move the same way, then it is not inverted
        kRollerMotorConfiguration.mode = MotorMode.kFlywheel;
        kRollerMotorConfiguration.withFOC = true;
        

        kRollerMotorConfiguration.maxVelocity = kRollerMotorConfiguration.getStandardMaxVelocity(MotorUtil.kKrakenX60FOC_MaxRPM);
        kRollerMotorConfiguration.maxAcceleration = kRollerMotorConfiguration.getStandardMaxVelocity(MotorUtil.kKrakenX60FOC_MaxRPM)*2.0;
