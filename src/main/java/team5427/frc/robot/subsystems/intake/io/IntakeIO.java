...
public interface IntakeIO {
    ...
    public class IntakeIOInput{
        ...
        //Initialized pivot motor's angular acceleratiopn to a random constant since acceleration cannot be simply 0
        ...
        public Current linearMotorCurrent = Amps.of(0.0);
        //sets voltages
