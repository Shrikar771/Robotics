...
import team5427.frc.robot.intake.IntakeIntaking;
import team5427.frc.robot.intake.IntakeStowed;
...
public class OperatorControls {
  ...
  private void initalizeTriggers() {
    ...
    // Superstructure.IntakeStates.IntakeTriggers.kIntaking.and(Superstructure.SwerveStates.SwerveTriggers.kIntake_Assistance).whileTrue(null);
